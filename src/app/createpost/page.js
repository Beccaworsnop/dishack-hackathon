    ...
    <div className="min-h-screen flex justify-center items-center bg-white p-4">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-6">
        <Link href="/profile" className="text-red-600 flex items-center mb-4 font-bold text-lg">
          <ArrowLeft className="mr-2" /> Create Post
        </Link>
        <hr className="mb-4" />
        ...
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            <h2 className="text-lg font-semibold">FEKKAI Ahmed</h2>
          </div>
        </div>
        ...
        <div className="flex justify-between mt-6">
          <button className="px-4 py-2 border border-red-600 text-red-600 rounded-full font-semibold hover:bg-red-100">
            Discard
          </button>
          <button className="px-6 py-2 bg-green-600 text-white rounded-full font-semibold hover:bg-green-700">
            Confirm
          </button>
        </div>
      </div>
