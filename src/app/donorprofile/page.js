    ...
    <div className="max-w-4xl mx-auto py-10">
      ...
      <header className="flex justify-between items-center mb-6">
        ...
        <nav className="flex space-x-6 text-lg font-medium">
          <a href="/postslist" className="hover:text-red-600">Donations</a>
          <a href="/hospitallist" className="hover:text-red-600">Hospitals</a>
          <a href="/pointtracker" className="hover:text-red-600">My Points</a>
      ...
      <Card className="p-6 shadow-md rounded-lg border border-gray-300">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div className="ml-auto flex space-x-2">
            ...
            <Link href="/editdonorprofil"><Button className="bg-red-600">edit profile</Button></Link>
          </div>
        </div>
      ...
      {/* Recent Posts */}
      <div className="mt-8">
        <h2 className="text-2xl font-bold text-red-600 mb-4">Recent Donation</h2>
        <Card className="p-4 border border-gray-300">
          <div className="flex justify-between">
            <p className="font-semibold text-gray-700">Hospital 1</p>
