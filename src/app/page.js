    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/background.jpg')" }}>
      ...
      <div className="relative z-10 text-center text-white">
        ...
        <div className="mt-6 flex flex-col items-center space-y-4">
          <Link href="/signIn"><button className="px-8 py-3 bg-white text-red-600 font-semibold rounded-full shadow-md hover:bg-gray-200">Sign In</button></Link>
          <Link href="/accounttype"><button className="px-8 py-3 bg-red-600 text-white font-semibold rounded-full shadow-md hover:bg-red-700">Register</button></Link>
        </div>
        <link href='/postslist'></link>
        <Link href="/hospitalProfile"></Link>
      </div>
    </div>
  );
}
